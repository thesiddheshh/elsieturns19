...
if not st.session_state.authenticated:
    ...
    st.markdown('<div class="pin-title">🔐 For Elsie Only</div>', unsafe_allow_html=True)
    ...
    if st.button("Unlock 💕", use_container_width=True):
        if pin == CORRECT_PIN:
            ...
            st.error("❌ Wrong PIN! Only Elsie knows the code.")
...
# -------------------------------
    ...
    # -------------------------------
    ELSI_MESSAGE = """five whole years. like, how did that even happen? sometimes it still blows my mind that someone i met online has become my person. there hasn’t been a single thing that’s happened — good, bad, stupid, or completely random — where my first instinct wasn’t “i gotta tell elsie.” you’ve become that one constant in my life, the one i can always run to, no matter what time it is or how i’m feeling.
...
love, siddh."""
    ...
    # ✅ FIXED: Safe, full handwritten font — no <p> artifact
